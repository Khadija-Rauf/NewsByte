...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async deleteTag(id) {
                try {
                    await axios.delete(`/newsbyte/tags/${id}`);
                    this.fetchTags();
                } catch (error) {
            ...
            async updateTag() {
                try {
                    const response = await axios.post(`/newsbyte/tags/${this.tag.id}`, this.tag);
            ...
            async fetchNews(newspaper) {
                try {
                    ...
                    const response = await axios.get(`/newsbyte/news/newspaper?newspaper=${newspaper}`);
            ...
            async assignTag(id, tag) {
                try {
                    const response = await axios.post(`/newsbyte/news/assign-tag/${id}`, tag);
            ...
            this.showTags = false;
                ...
                this.newsIrrespectiveOfTag= false;
                            ...
                            try {
                                //document.getElementById('news-loading-spinner').setAttribute("class", "spinner-border");
                                const response = await axios.get(`/newsbyte/news?type=${type}`);
                                this.news = response.data.news;
                                //document.getElementById('news-loading-spinner').setAttribute("class", "");
